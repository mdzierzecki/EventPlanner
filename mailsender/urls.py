...
from .views import MailingListView, EventMailingCreator, send_email, check_emails_sent, MailingDeleteView, MailingUpdateView
...
urlpatterns = [
    ...
    path('mailing/<int:id>/edit', MailingUpdateView.as_view(), name="mailing_update_view"),
